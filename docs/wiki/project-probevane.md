...
- 278 modules (247 util, 11 fetcher, 20 component); 11 touch the network
...
### src/arch/critique.ts — fetcher 🌐

- depends on: src/mock/graph.ts, src/mock/render.ts, src/arch/metrics.ts
...
- depends on: src/integrations/ado.ts, src/cli/args.ts

### src/cli/arch.ts — util

- depends on: src/arch/critique.ts, src/cli/args.ts
...
- depends on: src/adapters/registry.ts, src/loop/triage.ts, src/cost/simulate.ts, src/config.ts, src/git.ts, src/review/diff-review.ts, src/review/verify.ts, src/brain/select.ts, src/util/exec.ts, src/cli/args.ts
...
- depends on: src/config.ts, src/loop/run-docs.ts, src/cli/args.ts

### src/doctor/shared.ts — util
...
### src/doctor/lanes.ts — util

- depends on: src/util/exec.ts, src/doctor/shared.ts
...
### src/doctor/checks.ts — util

- depends on: src/util/exec.ts, src/doctor/shared.ts, src/doctor/lanes.ts
...
- depends on: src/doctor/checks.ts, src/adapters/registry.ts, src/cli/args.ts
...
- depends on: src/adapters/registry.ts, src/cli/args.ts, src/config.ts, src/loop/run-path.ts
...
- depends on: src/brain/select.ts, src/adapters/registry.ts, src/loop/run-generation.ts, src/config.ts, src/cli/args.ts
...
- depends on: src/adapters/registry.ts, src/loop/triage.ts, src/loop/draft-local.ts, src/brain/select.ts, src/util/concurrent.ts, src/brain/anthropic-sdk.ts, src/loop/run-generation.ts, src/config.ts, src/cli/args.ts, src/cli/generate-opts.ts
...
- depends on: src/adapters/registry.ts, src/git.ts, src/mock/graph.ts, src/loop/impact.ts, src/cli/args.ts
...
- depends on: src/adapters/registry.ts, src/quality/scan.ts, src/mfe/scan.ts, src/plan/build.ts, src/cli/args.ts
...
- depends on: src/config.ts, src/quality/analyze.ts, src/quality/scan.ts, src/git.ts, src/quality/baseline.ts, src/quality/sarif.ts, src/cli/args.ts
...
- depends on: src/cli/path-cli.ts, src/cli/args.ts, src/git.ts
...
### src/search/index.ts — util

- depends on: src/mock/graph.ts, src/search/embed.ts
...
- depends on: src/adapters/registry.ts, src/search/index.ts, src/search/embed.ts, src/cli/args.ts
...
- depends on: src/adapters/registry.ts, src/brain/select.ts, src/spec/build.ts, src/cli/args.ts
...
- depends on: src/adapters/registry.ts, src/config.ts, src/git.ts, src/cli/args.ts

### src/doctor/full.ts — util
...
- depends on: src/tui/layout.ts, src/ui/app/lib.ts
