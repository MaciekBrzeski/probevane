...
- 108 modules (105 util, 3 fetcher); 3 touch the network
- 3 network endpoint(s)
- test coverage: 26.25% statements, 69.06% branches
...
graph TD
  ...
  subgraph cli
    ...
    src_cli_distill_ts["cli/distill.ts (util)"]:::util
  ...
  subgraph distill
    src_distill_bases_ts["distill/bases.ts (fetcher) 🌐"]:::fetcher
    src_distill_collect_ts["distill/collect.ts (util)"]:::util
    src_distill_dataset_ts["distill/dataset.ts (util)"]:::util
  end
  subgraph e2e
    src_e2e_checkpoint_ts["e2e/checkpoint.ts (util)"]:::util
  end
  subgraph git.ts
  ...
  subgraph loop
    ...
    src_loop_runes_distill_trace_ts["loop/runes/distill_trace.ts (util)"]:::util
    ...
    src_loop_runes_visual_gate_ts["loop/runes/visual_gate.ts (util)"]:::util
  ...
  src_cli_distill_ts --> src_distill_collect_ts
  src_cli_distill_ts --> src_distill_dataset_ts
  src_cli_distill_ts --> src_distill_bases_ts
  src_cli_distill_ts --> src_adapters_registry_ts
  src_cli_distill_ts --> src_git_ts
  src_cli_distill_ts --> src_loop_passk_ts
  ...
  src_e2e_checkpoint_ts --> src_e2e_checkpoint_ts
  ...
  src_loop_profiles_ts --> src_loop_runes_visual_gate_ts
  ...
  src_loop_profiles_ts --> src_loop_runes_distill_trace_ts
  ...
  src_loop_runes_distill_trace_ts --> src_distill_collect_ts
  ...
  src_loop_runes_visual_gate_ts --> src_loop_rune_ts
  src_loop_runes_visual_gate_ts --> src_loop_runes_validation_gate_ts
...
### src/distill/collect.ts — util
  ...
  - exported functions: async recordTrace(ctx: RunCtx, now: string): Promise<number>; async readTraces(path): Promise<Trace[]>; TRACES_PATH (Call)
  - pure vitest unit test; `import { describe, it, expect } from "vitest"` explicitly; import the function and assert real values.
