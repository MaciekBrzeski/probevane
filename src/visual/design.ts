...
/** designLoop's inputs — the design CLI fills it; capture/ask are injectable test seams. */
...
/** What one judge/rewrite round produced — per-page findings + whether the CSS changed. */
...
// The design loop: shoot every page → vision judge → CSS rewrite (cssSelectors-gated) → repeat.
